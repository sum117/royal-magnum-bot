...
export const createSheetModalFieldIds = ["name", "backstory", "appearance"];
export const createRoyalSheetModalFieldIds = [...createSheetModalFieldIds, "royalTitle", "transformation"];
const getCreateSheetModal = (isRoyal) => {
    const modal = new ModalBuilder()
        .setTitle("Criação de ficha de personagem")
        .setCustomId(createSheetModalId)
        .addComponents(new ActionRowBuilder().setComponents(new TextInputBuilder()
        ...
        .setLabel("História")), new ActionRowBuilder().setComponents(new TextInputBuilder()
        ...
        .setLabel("Aparência")));
    if (isRoyal) {
        modal.addComponents(new ActionRowBuilder().setComponents(new TextInputBuilder()
            ...
            .setRequired(true)
            .setStyle(TextInputStyle.Short)
            .setLabel("Título Real")), new ActionRowBuilder().setComponents(new TextInputBuilder()
